...
//                 </div>
//                 <div onClick={clickedOnLogout} className='account-icon'><img src={imageOfAccountIcon} height={'31px'} width={'30px'} /></div>
//             </div>
    ...
    return (
        <>
            ...
            <div className='menu-blogimg-dashboard-buttons'>
                <div className='meun-icn' onClick={listenToHeader}><MenuIcon /></div>
                <img src={imageLogo} className='img-logo-blog' height={"35px"} />
                <Button onClick={onClickOnDashBoard} style={{color:'orange',marginLeft:'30px'}} className=''>Dashboard</Button>
                </div>
